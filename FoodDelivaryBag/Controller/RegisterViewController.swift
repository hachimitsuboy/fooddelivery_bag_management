...
//これからの課題
//1.選択されなかった時例）uberのままだった場合にはuberを選択させたい

import UIKit

//protocol deliveryInfoSetDelegate {
//    func deliveryInfoSet(foodInfo:FoodInfo)
//}
...
class RegisterViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    //プロトコルをインスタンス化 今回は
    //var delegate = deliveryInfoSetDelegate? = の書き方はできない
//    var delegate:deliveryInfoSetDelegate?
    ...
    @IBAction func register(_ sender: Any) {
        ...
        UserDefaults.standard.set(data, forKey: "foodInfo")
